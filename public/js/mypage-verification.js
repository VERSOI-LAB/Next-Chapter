...
const VERIFY_PERSUASION = {
  job: {
    title: '직업 인증',
    copy: 'SIGNATURE 상품 신청에 필요한 항목이에요. 인증을 마치면 이력에 대한 신뢰가 확실해지고, 프로필이 매칭 상대에게 우선적으로 노출돼요.',
  },
  education: {
    title: '학력 인증',
    copy: 'SIGNATURE 상품 신청에 필요한 항목이에요. 학력 정보는 대화의 결이 통하는 상대를 찾는 중요한 기준이며, 인증을 마치면 더 정교한 매칭이 가능해집니다.',
  },
  income: {
    title: '소득 인증',
    copy: 'SIGNATURE 상품 신청에 필요한 항목이에요. 소득 인증은 안정적인 라이프스타일을 보여주는 가장 확실한 신뢰의 지표입니다.',
  },
  asset: {
    title: '자산 인증',
